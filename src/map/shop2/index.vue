<template>
	<div class="content">
		...
		<!-- 商城 -->
		<Shop2 v-show="isShow.shopShow" @closeShop="closeShop" :key='componentKey' @forceRerender="forceRerender()"></Shop2>
	</div>
</template>

<script>
	import Tools from '../component/tools.vue'
	import Shop2 from './component/shop2.vue'
	export default {
		components: {
			Tools,
			Shop2,
		...
		data(){
			return{
				...
				ToolKey:0,
				imgUrl:{
					background:require('../../assets/img/兑换点.png')
				},
				isShow:{
					shopShow:false,
				}
